...
The split is behavior-preserving. It does not claim a new performance result.
The acceptance baseline remains the CPU-F32 DA3-BASE study on an AMD Ryzen 9
