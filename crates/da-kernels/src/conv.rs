...
pub use da3_kernels::NonoverlapTransposeF32;
...
pub fn prepare_nonoverlap_transpose_filter(
    ...
    da3_kernels::prepare_nonoverlap_transpose_f32(weight, in_c, out_c, kh, kw)
}
...
pub fn conv_transpose2d_prepared(
    ...
    da3_kernels::nonoverlap_transpose_f32(input, ih, iw, filter, bias, out)
}
    ...
    (0..tiles)
        ...
        .for_each(|tile0| {
            WINOGRAD_SCRATCH.with(|scratch| {
                ...
                let used_external = da3_kernels::winograd_f4_blocked_f32(
                    &filter.0,
                    &v[..36 * in_c * active],
